  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="fixed top-4 right-4 z-50 flex space-x-2">
        ...
        <Link
          href="/admin-login"
          className="inline-flex items-center px-4 py-2 text-sm bg-red-600 text-white hover:bg-red-700 rounded-lg transition-all duration-200 backdrop-blur-sm border border-red-500 font-bold"
          title="ADMINISTRAR - Acceso Directo"
        >
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
